# main.py menggunakan string koneksi yang disimpan ke DATABASE_URLvariabel lingkungan untuk terhubung ke klaster Anda dan mengeksekusi kode.
# Catatan:
# Aplikasi contoh menggunakan string koneksi umum, yang dimulai dengan postgresql://tetapi memodifikasinya sehingga menggunakan cockroachdb://awalan. Ini dilakukan agar SQLAlchemy akan menggunakan adaptor CockroachDB SQLAlchemy.
...
# Aplikasi akan terhubung ke CockroachDB, dan kemudian melakukan beberapa penyisipan, pembaruan, dan penghapusan baris sederhana.
...
# Dalam shell SQL yang terhubung ke kluster, Anda dapat memverifikasi bahwa baris berhasil disisipkan, diperbarui, dan dihapus:
"""
